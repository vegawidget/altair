...
1. `devtools::install_github("vegawidget/altair")`
...
I would recommend using this section only if you are having SSL-related installation difficulties, which may happen if you work at a corporate or institutional environment.
