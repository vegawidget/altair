...
rect <- 
  ...
  encode(
    ...
    y = alt$Y("Rotten Tomatoes Rating:Q", bin=TRUE),
    color = alt$Color(
      "count()",
...
base <-
  ...
  transform_calculate(
    # note - in a future release, this should be revisited
    rtg = "datum['IMDB_Rating']",
    rls_date = "datum['Release Date']",
    Rounded_IMDB_Rating = "floor(datum.rtg)",
    Hundred_Million_Production = "datum.Production_Budget > 100000000.0 ? 100 : 10",
    Release_Year = "year(datum.rls_date)"
  )$
  transform_filter(
    "datum['IMDB Rating'] > 0"
  )$
  transform_filter(
    ...
    y = alt$Y(field = "IMDB Rating", type = "quantitative"),
    tooltip = "Title:N"
  )
...
rating_color_condition <- 
  alt$condition(
    rating_select,
    alt$Color("MPAA Rating:N", legend = NULL),
    alt$value("lightgray")
  )
