...
This multi-line chart uses an invisible Voronoi tessellation to handle mouseover to identify the nearest point and then highlight the line on which the point falls. It is adapted from [amitkamp's block](https://bl.ocks.org/amitkaps/fe4238e716db53930b2f1a70d3401701).
