...
However, if you are using its defailts, you need not call the `vegawidget()` function explicity, as this package provides a `print()` method and a `knit_print()` method. 
