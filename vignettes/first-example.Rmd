...
There's a few things going on here. The first is that the altair (R) package exposes the Altair (Python) library using the variable `alt`. In the [Altair documentation](https://altair-viz.github.io/getting_started/overview.html), the convention is to expose the Altair library through the variable `alt`:
