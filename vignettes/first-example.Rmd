...
The argument to the `Chart()` function merits some explanation. In Python, a `data` argument is expected to be a Pandas Dataframe. Using this package, the reticulate package automaticaLLY converts R `data.frame`s to Pandas Dataframes.
