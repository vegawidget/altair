...
threshold <- data_frame(threshold =90)
...
chart <-
  ...
  transform_timeunit(
    ...
    mean_temp='mean(temp_max)', groupby=list('Month')
  )$transform_bin(
    list('bin_max', 'bin_min'), 'temp_max'
  )$transform_aggregate(
    value='count()', groupby=list('Month', 'mean_temp', 'bin_min', 'bin_max')
  )$transform_impute(
    impute='value', groupby=list('Month', 'mean_temp'), key='bin_min', value=0
  )$mark_area(
