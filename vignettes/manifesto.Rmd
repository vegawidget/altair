...
1. Tooltips.
1. Some infrastructure to create and publish [blocks](https://bl.ocks.org/). ([#19](https://github.com/ijlyttle/altair/issues/19))
1. Consolidating datasets within a chart specification. ([#26](https://github.com/ijlyttle/altair/issues/26))
