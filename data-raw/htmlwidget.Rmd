...
Here's a [reference](https://vega.github.io/vega/usage/#ie) to a solution to the promise-and-symbol issue that Alicia Schep brought up. 

As of 2015-05-31, the most current versions are [reference](https://github.com/vega/vega-lite/blob/v2.5.0/package.json):

- vega-lite 2.5.0 [link](https://www.jsdelivr.com/package/npm/vega-lite)
- vega 4.0.0-rc.2 [link](https://www.jsdelivr.com/package/npm/vega)
- vega-embed 3.14.0 [link](https://www.jsdelivr.com/package/npm/vega-embed)
